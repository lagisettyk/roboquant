...
#periodAnalysis('xiQuant-99-BBSMA20-CUSTOM-OCT20-2015','MasterOrders_BBSMAXOverMTM_Both_xiQuant-99-SMA-CUSTOM.csv', stdate, enddate, 360, 25)
#periodAnalysis('xiQuant-99-BBSMA20-SP-500-OCT20-2015','MasterOrders_BBSMAXOverMTM_Both_SP-500-SMA20-OCT20.csv', stdate, enddate, 360, 25)
...
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_BBSMAXOverMTM_Both_xiQuant-99-SMA-CUSTOM.csv', stdate, enddate, filterAction='both', rank=40)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_BBSMAXOverMTM_Both_SP-500-SMA20-OCT20.csv', stdate, enddate, filterAction='both', rank=25)
