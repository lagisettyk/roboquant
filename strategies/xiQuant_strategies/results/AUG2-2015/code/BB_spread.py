...
class BBSpread(strategy.BacktestingStrategy):
	...
	def onBars(self, bars):
		...
		self.__upperBBDataSeries, self.__middleBBDataSeries, self.__lowerBBDataSeries = indicator.BBANDS(self.__closeDS, len(self.__closeDS), self.__bbPeriod, 1.5, 1.5)
