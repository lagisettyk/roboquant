...
#enddate = dateutil.parser.parse('2015-08-15')
...
port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_SP-500-BASELINE.csv', stdate, enddate, filterAction='both', rank=20)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_SP-500-BB3PERCENT.csv', stdate, enddate, filterAction='both', rank=10000)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_SP-500-KIRAN.csv', stdate, enddate, filterAction='both', rank=50)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_SP-500_Aug17-2015.csv', stdate, enddate, filterAction='both', rank=10000)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_SP-500_Aug14-2015.csv', stdate, enddate, filterAction='both', rank=10000)
...
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_Abhi-26-BASELINE_INCLUDE3CHANGES.csv', stdate, enddate, filterAction='both', rank=20)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_Abhi-26-BB3PERCENT.csv', stdate, enddate, filterAction='both', rank=10000)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_Abhi-26-BASELINE_SAME_CANDLE_TYPE_AND_TRADE.csv', stdate, enddate, filterAction='both', rank=10000)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_Abhi-26-BASELINE_BB_SPREAD_TRADE_DAY_STOP_LOSS_PERCENTAGE.csv', stdate, enddate, filterAction='both', rank=10000)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_Abhi-26-BASELINE_BB_PRICE_CHECK_FOR_TOLERANCE_BREACH.csv', stdate, enddate, filterAction='both', rank=10000)
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_Abhi-26-BASELINE_PLUS_MFI.csv', stdate, enddate, filterAction='both', rank=10000)
...
#port_results = xiQuantStrategyUtil.run_master_strategy(100000, 'MasterOrders_Both_Abhi-26-BASELINE_PLUS_MFI_RES_CL.csv', stdate, enddate, filterAction='both', rank=10000)
...
#cashFlow = xiQuantStrategyUtil.computeIndicators('AAPL', stdate, enddate)
#print cashFlow
