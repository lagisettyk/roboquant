...
#SMA_PROFIT_CHECK_PERCENT = 1.0
SMA_PROFIT_CHECK_ABS = 0.1
EMA_PROFIT_CHECK_PERCENT_OR_ABS = 'Percent'
#EMA_PROFIT_CHECK_PERCENT = 2.0
...
PROFIT_LOCK_PERCENT_OR_ABS = 'ABS'
PROFIT_LOCK_PERCENT = 2.0
#PROFIT_LOCK_PERCENT = 1.0
PROFIT_LOCK_ABS = 2.0
